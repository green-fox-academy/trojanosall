...
namespace CalorieTableWebApp
{
    public class Startup
    {
        ...
        {
            var connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CalorieTableWebApp;Integrated Security=True;Connect Timeout=30";
            services.AddMvc();
